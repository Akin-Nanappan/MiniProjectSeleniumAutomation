...
public class ExtentReportManager {
	...
	public static ExtentReports getReportInstance(){
		...
		if(report == null){
			...
			report.setSystemInfo("Environment", "UI Testing");
			report.setSystemInfo("Build Number", "1.0.0");
			//report.setSystemInfo("Browser", "Chrome");
			
			htmlReporter.config().setDocumentTitle("Hackathon Testing Result");
			htmlReporter.config().setReportName("Hackathon Zigwheels.com");
